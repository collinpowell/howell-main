...
4. Define the Howell `ProtoAccount` for the `AccountKeeper`
...
9. Set the Howell `AnteHandler` to support EVM transactions. Note,
...
See the Howell [JSON-RPC docs](https://evmos.dev/basics/json_rpc.html) for reference.

## Documentation and Specification

* Howell documentation: [https://evmos.dev](https://evmos.dev)
