...
// GasPrice returns the current gas price based on Howell's gas price oracle.
...
func (e *PublicAPI) GetProof(address common.Address, storageKeys []string, blockNrOrHash rpctypes.BlockNumberOrHash) (*rpctypes.AccountResult, error) {
	...
	return &rpctypes.AccountResult{
		...
		StorageHash:  common.Hash{}, // NOTE: Howell doesn't have a storage hash. TODO: implement?
