// This is a test utility for Howell's Web3 JSON-RPC services.
//
// To run these tests please first ensure you have the howelld running
// and have started the RPC service with `howelld rest-server`.
//
