...
// transactions. There should only be a single implementation in Howell. For
// the purposes of Howell, it should be support retrieving headers and
// consensus parameters from  the current blockchain to be used during
// transaction processing.
//
// NOTE: Howell will distribute the fees out to validators, so the structure
