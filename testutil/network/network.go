...
func DefaultConfig() Config {
	...
	return Config{
		...
		ChainID:           fmt.Sprintf("howell_%d-1", tmrand.Int63n(9999999999999)+1),
		NumValidators:     4,
...
func New(l Logger, baseDir string, cfg Config) (*Network, error) {
	...
	for i := 0; i < cfg.NumValidators; i++ {
		...
		nodeDir := filepath.Join(network.BaseDir, nodeDirName, "howelld")
		clientDir := filepath.Join(network.BaseDir, nodeDirName, "howellcli")
